  ...
  return (
    <section className=" h-auto mb-[60px] md:mb-0 w-full header  ">
        <header className="header-gradient h-full flex flex-col  gap-[20px]">
            ...
            <h1 className="heading-1 md:w-7/12 md:mx-auto text-[#28282B] px-[10px]">Seamless <span className="text-[#962985]">Pathways </span> to Study Work and <span className="text-[#962985]"> Live Abroad </span> </h1>
            <p className="heading-paragraph w-10/12 md:w-7/12 mx-auto text-[#28282B]">Unlock the easiest pathways to study, work, or settle abroad. Let us guide you through every step with trusted expertise and a seamless process. Start your journey today</p>
