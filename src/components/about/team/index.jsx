...
const Team = () => {
  return (
    <section className="bg-[#F9F2F8CC] overflow-hidden">
      <div className="h-full  py-[20px] flex flex-col gap-[20px]">
        <motion.div
          ...
          <p className="heading-2-paragragh w-full px-[10px] mx-auto text-center md:w-[70%] lg:w-[45%]">
        ...
        <div className="md:w-11/12 md:mt-[40px] w-[90%] mx-auto flex flex-col md:flex-row lg:gap-[200px]  gap-[30px]">
          <motion.div
